...
export const MOCK_BLOCKS: PixelBlock[] = [
  ...
  { id: "m2", x: 200, y: 120, w: 60, h: 40, fill: "color", color: "#ef4444", status: "active", ownerName: "RougeVif", message: "RougeVif", link: "https://example.com" },
  ...
  { id: "m6", x: 600, y: 400, w: 90, h: 90, fill: "color", color: "#a855f7", status: "active", ownerName: "Violet" },
